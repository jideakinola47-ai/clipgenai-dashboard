    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <h1 style={{ fontSize: 28, fontWeight: 700, color: theme.text, marginBottom: 8 }}>Welcome Back</h1>
          <p style={{ color: theme.textMuted, fontSize: 14 }}>Sign in to your account</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{
            ...
            <Link to="/forgot-password" style={{ color: theme.accent, textDecoration: 'none', fontSize: 13 }}>
              Forgot password?
            </Link>
          </div>
        ...
        <div style={{ textAlign: 'center', marginTop: 24 }}>
          <span style={{ color: theme.textMuted, fontSize: 13 }}>
            ...
            <Link to="/signup" style={{ color: theme.accent, textDecoration: 'none', fontWeight: 600 }}>
              Create account →
            </Link>
          </span>
        </div>

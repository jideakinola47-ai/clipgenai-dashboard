...
export default function Dashboard({ onClipsReady }) {
  ...
  return (
    <div style={{ padding: "32px", maxWidth: "1100px", margin: "0 auto" }}>
      ...
      <div
        ...
        style={{
          border: `2px dashed ${dragging ? "#7c6af7" : file ? "#4caf50" : "#3a3a4a"}`,
      ...
      >
        ...
        {file ? (
          <>
            ...
            <div style={{ color: "#fff", fontWeight: 600, fontSize: "16px" }}>{file.name}</div>
            ...
            <button onClick={e => { e.stopPropagation(); setFile(null); setProgress(null); setError(""); }}
              style={{ marginTop: "12px", background: "none", border: "1px solid #444",
                color: "#aaa", padding: "4px 16px", borderRadius: "8px", cursor: "pointer" }}>
              Remove
            </button>
          </>
        ) : (
          <>
            <div style={{ fontSize: "40px", marginBottom: "12px" }}>🎬</div>
            <div style={{ color: "#fff", fontWeight: 600, fontSize: "18px" }}>Drop your video here</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "16px", marginBottom: "24px" }}>
        ...
        <div style={{ background: "rgba(255,255,255,0.05)", borderRadius: "12px", padding: "20px" }}>
          <div style={{ color: "#888", fontSize: "11px", letterSpacing: "1px", marginBottom: "12px" }}>CONTENT STYLE</div>
          <select value={style} onChange={e => setStyle(e.target.value)}
            style={{ width: "100%", background: "#1a1a2e", color: "#fff", border: "1px solid #333",
        ...
        {/* Target platform */}
        <div style={{ background: "rgba(255,255,255,0.05)", borderRadius: "12px", padding: "20px" }}>
          <div style={{ color: "#888", fontSize: "11px", letterSpacing: "1px", marginBottom: "12px" }}>TARGET PLATFORM</div>
            ...
            {PLATFORMS.map(p => (
              <div key={p} onClick={() => togglePlatform(p)}
                style={{ padding: "8px 12px", borderRadius: "8px", cursor: "pointer", fontSize: "14px",
                  ...
                  color: platforms.includes(p) ? "#a99ff7" : "#888" }}>
                {p}
        ...
        {/* Advanced options */}
        <div style={{ background: "rgba(255,255,255,0.05)", borderRadius: "12px", padding: "20px" }}>
          <div style={{ color: "#888", fontSize: "11px", letterSpacing: "1px", marginBottom: "16px" }}>ADVANCED OPTIONS</div>
          {[["Auto-captions", autoCap, setAutoCap], ["Viral optimization", viral, setViral]].map(([label, val, set]) => (
            <div key={label} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
              ...
              <div onClick={() => set(!val)} style={{
                ...
                background: val ? "#7c6af7" : "#333", position: "relative", transition: "background 0.2s"
              }}>
                <div style={{
          ...
          <div style={{ color: "#888", fontSize: "11px", letterSpacing: "1px", marginBottom: "8px" }}>SUBTITLE LANGUAGE</div>
      ...
      <button
        ...
        style={{
          ...
          background: !file || progress ? "#333" : "linear-gradient(135deg, #7c6af7, #a855f7)",
          color: !file || progress ? "#666" : "#fff",
